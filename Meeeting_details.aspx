...
<script type="text/javascript" src="js/tabulousjs.js"></script> 
    <script type="text/javascript">
        ...
        //meeting attended status type
        //day1
        $('#checkboxG5').change(function () {
            ...
            if ($(this).is(':checked') == true) {
                $(".meetrow").each(function (index) {
                    ...
                    var statusday1 = $('#' + id).data('day1main');
                    var statusday2 = $('#' + id).data('day2main');
                    var statustypeday1 = $('#' + id).data('meetingstatustype');


                    console.log(statustypeday1 + "day1");
                    alert(statustypeday1);
