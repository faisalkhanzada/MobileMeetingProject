<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" Inherits="all_list" Codebehind="all_list.aspx.cs" %>
      ...
      <div class="maintextright_right alllisttable">
        ...
        <div class="vtablelist list">
          ...
          <% Response.Write(list); %>
              ...
              <asp:GridView ID="GridView1" Visible="false" runat="server" CssClass="vtablelist" AutoGenerateColumns="False" OnLoad="GridView1_Load">
                  <Columns>
